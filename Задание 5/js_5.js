...
s.textContent = '';
if (!(typeof value1 !== "number" && value1 >= 1 && value1 <= 10)) {
  s.textContent = 'Номер страницы вне диапазона от 1 до 10';
  return;
} else if(!(typeof value2 !== "number" && value2 >= 1 && value2 <= 10)) {
  s.textContent = 'Лимит вне диапазона от 1 до 10';
  return;
} else if(!(typeof value1, value2 !== "number" && value1 >= 1 && value1 <= 10 && value2 >= 1 && value2 <= 10)) {
